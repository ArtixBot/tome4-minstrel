...
newEntity{ base = "BASE_AMULET",
	...
	unided_name = "dull gray amulet",
	desc = [[Once a common bauble of wanderers and minstrels alike, songstone amulets mysteriously lost their power after the Spellblaze. Though this one is broken beyond repair, it still possesses slight remnants of power, strangely enough.]],
	level_range = {1, 5},
	rarity = 200,
	cost = 90,
	material_level = 1,
